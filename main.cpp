...
int main(int argc, char* argv[])
{
	...
	//cin >> minMathScore;
	//cout << "введите минимальное значение баллов по русскому €зыку: ";
	//cin >> minRuLangScore;
	//cout << "введите минимальное значение баллов по английскому: ";
	//cin >> minEnLangScore;

	//	основные переменные 
	//Array Exam(ReadingBinaryFile();				//	контейнер дл€ неупор€доченного хранени€ данных пользовател€ в пам€ти
	//u_int horizontalPos = 1, verticalPos = 1;	//	переменные положени€ меню

	bool	exitFlag = true;	//	флаг выхода из программы 
	short	codeItem(0);		//	состо€ние клавиатуры
